...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct?method=edit" method="post" enctype="multipart/form-data">
	...
	$(function() {
		...
		$.get("${pageContext.request.contextPath}/category?method=index",
				function(data) {
					//获取元素
					$('#menuId').html("<option>--请选择哦--</option>");
					$(data).each(
							function() {
								$('#menuId').append(
