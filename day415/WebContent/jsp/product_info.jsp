					...
					<div class="col-md-6">
						...
						<form action="${pageContext.request.contextPath}/cart?method=add" method="post" id="formId">
							...
							<div class="col-md-6">
								...
								<div style="margin:10px 0 10px 0;">市场价: <strong style="color:#ef0101;">￥：${bean.shop_price }元/份</strong> 参 考 价： <del>￥${bean.market_price }元/份</del>
								</div>
								...
								<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
									...
									<div style="margin:20px 0 10px 0;;text-align: center;">
										<a href="javascript:void(0)" onclick="subByid()">
